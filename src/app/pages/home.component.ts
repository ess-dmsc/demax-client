...
@Component({
	selector: 'app-home',
	template: `
		<h3>Welcome to the DEMAX user portal for deuteration & crystallization support!</h3>
		...
		<button class="btn btn-primary" style="margin: 2rem 4rem;" routerLink="/proposals">Create new proposal</button>
		<button class="btn btn-danger" routerLink="/proposals">View my proposals</button>
