...
@Component({
  ...
  template:`
	  <mat-card style="max-width: 900px; margin: 0;">
		  ...
		  <img mat-card-image src="../../assets/media/crystal-diffraction-gray.png" alt="crystal diffraction"
		       width="440">
		  <mat-card-content>
			  ...
			  <ul>
				  ...
				  <li> During initial operations we will not limit access to DEMAX based on ESS-membership. Beyond this
					  period
					  we
		  ...
		  <mat-card-actions>
			  ...
			  <button mat-raised-button style="background-color: dodgerblue; color: white;">Download proposal template
			  </button>
		  </mat-card-actions>
		  <mat-card-footer>
